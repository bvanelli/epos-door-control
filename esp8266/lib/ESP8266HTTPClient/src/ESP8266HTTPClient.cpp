...
public:
    ...
    bool verify(WiFiClient& client, const char* host) override
    {
        ...
        /* @Overwrite: Return true and don't verify servers fingerprint
...
bool HTTPClient::begin(String url, String httpsFingerprint)
{
    ...
    _port = 443;
    /* @Overwrite: Don't check the length
...
bool HTTPClient::beginInternal(String url, const char* expectedProtocol)
{
    ...
    /* @Overwrite: Add a default / route when no route is present */
    if(url.indexOf('/') == -1)
        url += "/";
    index = url.indexOf('/');
...
bool HTTPClient::connect(void)
{
    ...
    /* @Overwrite: Don't verify the fingerprint for now
