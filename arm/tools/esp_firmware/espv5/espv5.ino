...
public:
    ...
    bool connect_to_wifi() {
        ...
        WiFi.mode(WIFI_STA);
        wifi_station_set_username((uint8*)username, sizeof(username));
    ...
    bool connect_to_wifi_automatically() {
...
void act(){
    ...
    } else if(strncmp(action,"CONNECTWIFIAUTOMATIC",action_size) == 0){
        bool result = iot->connect_to_wifi_automatically();
